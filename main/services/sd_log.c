/**
 * @file sd_log.c
 * @brief Persistent exception/event logging via LittleFS on internal flash.
 *
 * The board has no SD card slot, so we use a LittleFS partition
 * named "storage" on the internal flash (7 MB).
 * Logs are written to /log/exceptions.txt with timestamps.
 */
